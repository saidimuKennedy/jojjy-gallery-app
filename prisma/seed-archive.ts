...
async function main() {
  ...
  await prisma.mediaBlogEntry.create({
    data: {
      ...
      thumbnailUrl: IMG.dawn,
      mediaFiles: {
        create: [
          { url: IMG.dawn, type: MediaFileType.IMAGE, description: "Dawn", order: 0 },
          {
            url: IMG.crossing,
            type: MediaFileType.IMAGE,
